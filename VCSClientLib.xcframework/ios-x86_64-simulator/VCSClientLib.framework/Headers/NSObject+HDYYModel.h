 ...
 */
+ (nullable instancetype)hdyy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)hdyy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)hdyy_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)hdyy_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)hdyy_modelToJSONObject;
 ...
 */
- (nullable NSData *)hdyy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)hdyy_modelToJSONString;
 ...
 */
- (void)hdyy_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)hdyy_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)hdyy_modelIsEqual:(id)model;
 ...
 */
- (NSString *)hdyy_modelDescription;
 ...
 */
+ (nullable NSArray *)hdyy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (HDYYModel)
 ...
 */
+ (nullable NSDictionary *)hdyy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)hdmodelCustomPropertyMapper;
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)hdmodelContainerPropertyGenericClass;
 ...
 */
+ (nullable Class)hdmodelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)hdmodelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)hdmodelPropertyWhitelist;
 ...
 */
- (NSDictionary *)hdmodelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)hdmodelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)hdmodelCustomTransformToDictionary:(NSMutableDictionary *)dic;
